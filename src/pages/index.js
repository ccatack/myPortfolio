  ...
  return (
    <PageLayout
      ...
      hero={
        <Hero
          title="Corbin Atack"
          subtitle="Hi! I am newly graduated with a degree in computer science and art, looking for opportunities to leverage my skills in front end and full stack design and development."
          className="mt-12 lg:mt-0 lg:flex-grow"
        />
      }
    >
      <video
        ...
        autoPlay
        muted
        className="hidden lg:block absolute right-0 -z-10 h-full"
