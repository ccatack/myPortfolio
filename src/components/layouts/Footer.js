  ...
  return (
    <div className="hidden bg-white h-12 lg:flex flex-row items-center justify-end">
      <div className="text-xs text-gray-500">
        Copyright {getYear()} Corbin Atack
      </div>
      <a
      ...
      >
        <img
          src={LILogo}
          className="ml-6 h-8 max-h-full opacity-40 hover:opacity-80 cursor-pointer"
        ></img>
      </a>
      ...
      >
        <img
          src={EmailLogo}
          className="ml-6 mr-8 h-8 max-h-full opacity-40 hover:opacity-80 cursor-pointer"
        ></img>
      </a>
      <Tooltip
        id="my-tooltip"
